import {
  ...
  UPDATE_CAT_FAVOURITE,
  UPDATE_CAT_FAVOURITE_SUCCESS,
  UPDATE_CAT_FAVOURITE_FAILURE,
} from "./actions";
...
export default function (state = initialState, action) {
  switch (action.type) {
    case UPDATE_CAT_FAVOURITE: {
      return {
        ...state,
        isLoading: true,
      };
    }
    case UPDATE_CAT_FAVOURITE_SUCCESS: {
    ...
    case UPDATE_CAT_FAVOURITE_FAILURE: {
      return {
        ...state,
        isLoading: false,
